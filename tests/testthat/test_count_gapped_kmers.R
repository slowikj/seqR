...
test_that("(string vector input) count non positional k-mers (0, 1)", {
...
test_that("(string vector input) count non positional k-mers (0, 1); some items are not allowed", {
...
test_that("(string vector input) the k-mer is longer than the sequence", {
  sequences <- c("AAAACAAAAC", "AACTAAAA", "AACTAAAAC")
...
# TIDYSQ VECTOR INPUT TESTS ----

test_that("(tidysq input) count non positional k-mers (0, 1)", {
...
test_that("(tidysq input) count non positional k-mers (0, 1); some items are not allowed", {
