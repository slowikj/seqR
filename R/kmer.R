...
#' and additionally, if non positional k-mers are used, all possible to create using the given alphabet are returned,
...
#' @example count_kmers(c("a", "b", "c"), c(0), c("a", "b"), FALSE)
