...
count_kmers_integer_proxy <- function(sequences, ...) {
  .invoke_kmer_function(rcpp_counting_function=count_kmers_integer,
...
count_kmers_string_proxy <- function(sequences, ...) {
  .invoke_kmer_function(rcpp_counting_function=count_kmers_string,
...
count_kmers_numeric_proxy <- function(sequences, ...) {
  .invoke_kmer_function(rcpp_counting_function=count_kmers_numeric,
...
count_kmers_tidysq_proxy <- function(sequences, ...) {
  .invoke_kmer_function(rcpp_counting_function=count_kmers_tidysq,
                        alphabet_validator=validate_string,
                        sequences=sequences,
                        ...)
}
