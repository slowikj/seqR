...
public:
    ...
    LinearListDictionary(const LinearListDictionary<K, V> &) = default;

    LinearListDictionary<K, V> &operator=(const LinearListDictionary<K, V> &) = default;

    LinearListDictionary<K, V> &operator=(LinearListDictionary<K, V> &&) noexcept = default;

    LinearListDictionary(LinearListDictionary<K, V> &&) noexcept = default;
