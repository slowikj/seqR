...
RcppExport SEXP _rcpp_module_boot_integer_kmers_computer();
RcppExport SEXP _rcpp_module_boot_numeric_kmers_computer();
RcppExport SEXP _rcpp_module_boot_string_kmers_computer();
RcppExport SEXP _rcpp_module_boot_tidySq_kmers_computer();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_integer_kmers_computer", (DL_FUNC) &_rcpp_module_boot_integer_kmers_computer, 0},
    {"_rcpp_module_boot_numeric_kmers_computer", (DL_FUNC) &_rcpp_module_boot_numeric_kmers_computer, 0},
    {"_rcpp_module_boot_string_kmers_computer", (DL_FUNC) &_rcpp_module_boot_string_kmers_computer, 0},
    {"_rcpp_module_boot_tidySq_kmers_computer", (DL_FUNC) &_rcpp_module_boot_tidySq_kmers_computer, 0},
    {NULL, NULL, 0}
};
